...
/**
 * This controller handles the /api/v1/user-profile/* URL pattern for backward compatibility.
...
@Tag(name = "User Profile API v1", description = "User profile management endpoints with backward compatibility")
